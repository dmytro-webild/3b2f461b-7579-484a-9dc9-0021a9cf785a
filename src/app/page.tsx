...
export default function LandingPage() {
  ...
  <div id="hero" data-section="hero">
      ...
      leftCarouselItems={[
        ...
        { imageSrc: "http://img.b2bpic.net/free-photo/tired-sportsman-with-ball-stadium_23-2147820650.jpg", imageAlt: "Hero scene 5" },
        { imageSrc: "http://img.b2bpic.net/free-photo/green-ferromagnetic-liquid-metal-with-copy-space_23-2148253629.jpg", imageAlt: "Hero scene 6" },
      ]}
      rightCarouselItems={[
        { imageSrc: "http://img.b2bpic.net/free-photo/american-football-american-football-player-professional-sport-stadium_654080-414.jpg", imageAlt: "Hero scene 7" },
        { imageSrc: "http://img.b2bpic.net/free-photo/sporty-girl-holding-soccer-ball-her-hands-girl-soccer-player-soccer-training-soccer_169016-67931.jpg", imageAlt: "Hero scene 8" },
        { imageSrc: "http://img.b2bpic.net/free-photo/modern-close-up-ferromagnetic-metal_23-2148253626.jpg", imageAlt: "Hero scene 9" },
        { imageSrc: "http://img.b2bpic.net/free-photo/girl-soccer-player-girl-sports-uniform-soccer-field-football-concept_169016-68375.jpg", imageAlt: "Hero scene 10" },
        { imageSrc: "http://img.b2bpic.net/free-photo/medium-shot-man-soccer-field_23-2150338694.jpg", imageAlt: "Hero scene 11" },
        { imageSrc: "http://img.b2bpic.net/free-photo/view-empty-football-stadium_23-2151569871.jpg", imageAlt: "Hero scene 12" },
      ]}
      buttons={[
        { text: "Start Training", href: "#pricing" },
        { text: "Watch Demo", href: "#video" },
      ]}
    />
  </div>
  ...
  <div id="training" data-section="training">
      ...
      features={[
        ...
        { title: "Shooting", description: "Precision shooting techniques for every position.", imageSrc: "http://img.b2bpic.net/free-photo/artistic-background-wallpaper-with-color-halftone-effect_58702-9104.jpg" },
      ]}
  ...
  <div id="video" data-section="video">
      ...
      products={[
        ...
        { id: "3", name: "Tactical Sessions", price: "Premium", variant: "Pro", imageSrc: "http://img.b2bpic.net/free-photo/happy-best-friends-playing-chess-video-call-coronavirus-quarantine-drinking-beer-eating-popcorn_482257-19637.jpg" },
        { id: "4", name: "Goalkeeper Drills", price: "Premium", variant: "Advanced", imageSrc: "http://img.b2bpic.net/free-photo/watching-football-concept-with-vr-glasses_23-2147813139.jpg" },
        { id: "5", name: "Strength Workouts", price: "Access", variant: "Basic", imageSrc: "http://img.b2bpic.net/free-photo/photographer-filming-content-discussing-about-software-used-perform-image-editing_482257-82250.jpg" },
        { id: "6", name: "Agility Drills", price: "Premium", variant: "Pro", imageSrc: "http://img.b2bpic.net/free-photo/football-trainer-teaching-his-pupils_23-2149708008.jpg" },
      ]}
  ...
  <div id="dashboard" data-section="dashboard">
      ...
      metrics={[
        ...
        { id: "m3", value: "50+", title: "Sessions", description: "Completed training streaks", icon: TrendingUp },
      ]}
  ...
  <div id="analysis" data-section="analysis">
      ...
      heading={[
        ...
        { type: "text", content: " Match Analysis" },
      ]}
    />
  </div>
  ...
  <div id="community" data-section="community">
      ...
      testimonials={[
        ...
        { id: "t3", title: "Love the Drills", quote: "Pro skills videos are incredibly clear.", name: "Emily R.", role: "Player", imageSrc: "http://img.b2bpic.net/free-photo/front-view-male-rugby-player-holding-ball-smartphone_23-2148793385.jpg" },
        { id: "t4", title: "Great Community", quote: "Shared my goal and got feedback fast.", name: "David K.", role: "Youth", imageSrc: "http://img.b2bpic.net/free-photo/two-men-looking-phone_23-2148264719.jpg" },
        { id: "t5", title: "Highly Recommended", quote: "Perfect for tactical understanding.", name: "James L.", role: "Player", imageSrc: "http://img.b2bpic.net/free-photo/medium-shot-women-taking-selfie_23-2149161246.jpg" },
      ]}
